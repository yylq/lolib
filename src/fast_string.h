...
#ifndef _FAST_STRING_H
#define _FAST_STRING_H
...
#define FAST_UNESCAPE_URI       1
#define FAST_UNESCAPE_REDIRECT  2
...
uchar_t  *string_utf8_cpystrn(uchar_t *dst, uchar_t *src, size_t n, size_t len);
uintptr_t string_escape_uri(uchar_t *dst, uchar_t *src, size_t size,uint32_t type);
void      string_unescape_uri(uchar_t **dst, uchar_t **src, size_t size, uint32_t type);
